...
training_data_url = 'https://raw.githubusercontent.com/AdamMonroUnil/DSML/main/Data/more_duplicated_training_data.csv'
...
results.to_csv('submission36.csv', index=False)
